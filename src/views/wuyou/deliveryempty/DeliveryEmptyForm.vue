    ...
    methods: {
     ...
     async open(id) {
        ...
        if (id) {
          ...
          try {
            const res = await DeliveryEmptyApi.getDeliveryEmpty(id);
      ...
      async submitForm() {
        ...
        try {
          const data = this.formData;
                  // 修改的提交
          if (data.id) {
            await DeliveryEmptyApi.updateDeliveryEmpty(data);
          ...
          // 添加的提交
          await DeliveryEmptyApi.createDeliveryEmpty(data);
